...
var Traveler = function (_Person2) {
  ...
  function Traveler(name, age, occupation) {
    var homeLocation = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'From Around Here';

    _classCallCheck(this, Traveler);

    var _this2 = _possibleConstructorReturn(this, (Traveler.__proto__ || Object.getPrototypeOf(Traveler)).call(this, name, age, occupation));
...
var traveller1 = new Traveler('luke', 29, 'Programmer', '');
